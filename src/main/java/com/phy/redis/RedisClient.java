...
public class RedisClient {
	...
	private ShardedJedis shardedJedis;// 切片客户端连接池
	...
	private void initialPool() {
		...
		jedisPool = new JedisPool(config, "192.168.201.99", 7000);
	}
	...
	private void initialShardedPool() {
		...
		JedisShardInfo shareInfo = new JedisShardInfo("192.168.201.99", 7000,
				"master");
		shareInfo.setPassword("123456");
	 ...
	 * @param value
	 */
	public String readMsg(String key, String value) {
		// TODO Auto-generated method stub
		if (jedis.exists(key)) {
